...
public final class TilesDefinitions implements DefinitionsFactory {
    ...
    public static void addDefinitions() {
        addDefaultLayoutDef("defaultLayout", "Home", "/WEB-INF/views/layout/defaultLayout.jsp");
    }
